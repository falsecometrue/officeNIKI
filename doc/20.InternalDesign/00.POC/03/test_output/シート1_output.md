...
- id: `embed_2068220731` class: `waffle-embedded-object-overlay` style: `width: 698px; height: 215px; display: block;` width: `698` height: `215` x: `98` y: `16` row: `2` col: `0` src: `resources/drawing0.png`
...
Draw.io XML は `poc03_drawio_hints.dio` / `poc03_drawio_hints.svg.dio` に出力しています。